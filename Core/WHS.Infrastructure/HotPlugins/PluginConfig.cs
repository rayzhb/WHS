...
namespace WHS.Infrastructure.HotPlugins
{
    ...
    public class PluginConfig
    {
        ...
        public List<string> AdditionalProbingPaths { get; set; } = new();
        public List<string> ResourceProbingPaths { get; set; } = new();
        public List<string> ResourceProbingSubpaths { get; set; } = new();
