...
namespace WHS.DEVICE.MAPDESIGN
{
    ...
    using WHS.DEVICE.MAPDESIGN.Converters;

    using PropertyTools.Wpf;
    using WHS.DEVICE.MAPDESIGN.Validation;
    ...
    public class CustomControlFactory : PropertyGridControlFactory
    {
        ...
        {
            this.Converters.Add(new PropertyConverter(typeof(Length), new Converters.LengthConverter()));
        }
